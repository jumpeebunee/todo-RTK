  ...
  return (
    <li onClick={(e) => handleOpen(e)} className="app__item">
      <div className="app__item-content">
        <div onClick={(e) => e.stopPropagation()}>
          <label className="app__item-checkbox">
            <input
              ...
              className="app__item-checkbox-input"
              type="checkbox"
            />
        ...
        {isEditable ? (
          <input
            ...
            value={editTitle}
            className="app__item-edit-input"
            type="text"
          />
        ) : (
          <h3
            className={
              !todo.completed
                ? "app__item-heading"
                : "app__item-heading app__item-heading_active"
            }
          >
            {todo.title}
          </h3>
      ...
      <div
        className={
          isOpen
            ? "app__item-options app__item-options_active"
            : "app__item-options"
        }
      >
        <button onClick={handleDelete} className="app__item-delete">
          Delete todo
        </button>
        {isEditable ? (
          <button onClick={(e) => handleEdit(e)} className="app__item-edit">
            Confirm
          </button>
        ) : (
          <button onClick={(e) => handleEdit(e)} className="app__item-edit">
